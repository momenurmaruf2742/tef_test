...
urlpatterns = [
    ...
    path('cybersecurity-/', views.categoryView, name='cybersecurity-'),
    path('cybersecurity-<name>/', views.categoryView, name='cybersecurity-'),
    path('cybersecurity-<str:name1>/<str:name2>/',
         views.category_detailView, name='cybersecurity-'),
    path('cybersecurity-<str:name1>/<str:name2>/<str:name3>/',
